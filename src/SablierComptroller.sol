...
contract SablierComptroller is ISablierComptroller, RoleAdminable {
    ...
    function disableCustomFeeUSDFor(Protocol protocol, address user) external override onlyRole(FEE_MANAGEMENT_ROLE) {
        ...
        // Log the update.
        emit ISablierComptroller.DisableCustomFeeUSD(protocol, msg.sender, user);
    }
        ...
        notExceedMaxFeeUSD(customFeeUSD)
    {
        ...
        // Log the update.
        emit ISablierComptroller.SetCustomFeeUSD(protocol, msg.sender, user, customFeeUSD);
    }
        ...
        notExceedMaxFeeUSD(newMinFeeUSD)
    {
        ...
        // Log the update.
        emit ISablierComptroller.SetMinFeeUSD(protocol, msg.sender, previousMinFeeUSD, newMinFeeUSD);
    }
